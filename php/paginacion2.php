...
$consulta = "SELECT * FROM agresores ORDER BY nombre ASC LIMIT $inicio, $registros_por_pagina";
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
        ?>
        <tr class="fila-tabla text-center" data-dni="<?php echo $fila['dni']; ?>" id="<?php echo $fila['dni']; ?>">
            <td><img src="php/files/<?php echo $fila['img']; ?>" width="45"></td>
            <td style="vertical-align: middle;"><?php echo $fila['dni']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['nombre']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['edad']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['victima']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['violencia']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['direccion']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['contacto']; ?></td>
            <td style="vertical-align: middle;"><?php echo $fila['denuncias']; ?></td>
        </tr>
        <?php
    }
    ...
    $consulta_total = "SELECT COUNT(*) AS total FROM agresores";
    ...
    <table class="table table-light table-striped table-sm">
        ...
        <tr>
            <td colspan="9" class="nodata text-center text-white bg-dark">No se encontraron datos.</td>
        </tr>
    <?php
}
